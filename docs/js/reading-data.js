...
const reproDetails = {
  1: {
    ...
    notes: "Gaussian proxy smoothing is used as a lightweight proxy for convex ROF/TV smoothing on a synthetic toy image."
  },
  2: {
    reproductionLevel: "toy-to-partial",
    difficultyScore: 3,
  ...
  3: {
    ...
    implementationRisk: "partial 升级已用 ROF solver 替代 Gaussian proxy 主路径，并按 Eq. (15) 用 raw f 计算 mean_f(Omega_i)；仍不等同于 Theorem 1 完整证明或论文真实数据实验。",
