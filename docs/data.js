...
const PAPERS_DATA = {
    ...
    papers: [
        { id: 1, title: "Thylakoid Electron Tomography", titleEn: "Thylakoid Electron Tomography", year: 2019, category: "医学图像", status: "filled", status: "filled", pdfFile: "2019_Thylakoid_Electron_Tomography.pdf", noteFile: "叶绿体电子断层扫描 Thylakoid.md" },
        ...
        { id: 7, title: "Diffusion Brain MRI", titleEn: "Diffusion Brain MRI", year: 2024, category: "医学图像", status: "filled", status: "filled", pdfFile: "2024_2405.04974_Diffusion_Brain_MRI.pdf", noteFile: "Discrepancy-based_Diffusion_MRI_超精读笔记_已填充.md" },
        ...
        { id: 19, title: "CenSegNet中心体", titleEn: "CenSegNet", year: 2025, category: "医学图像", status: "filled", status: "filled", pdfFile: "CenSegNet中心体 CenSegNet.pdf", noteFile: "CenSegNet_中心体表型分析_超精读笔记.md" },
        ...
        { id: 23, title: "HiFi-Mamba MRI重建", titleEn: "HiFi-Mamba", year: 2025, category: "医学图像", status: "filled", status: "filled", pdfFile: "HiFi-Mamba MRI重建 HiFi-Mamba MRI Reconstruction.pdf", noteFile: "HiFi-Mamba_MRI_Reconstruction_超精读笔记_已填充.md" },
        { id: 24, title: "HiFi-MambaV2分层MRI", titleEn: "HiFi-MambaV2", year: 2025, category: "医学图像", status: "filled", status: "filled", pdfFile: "HiFi-MambaV2分层MRI HiFi-MambaV2 Hierarchical MRI.pdf", noteFile: "HiFi-MambaV2_Hierarchical_MRI_超精读笔记_已填充.md" },
        ...
        { id: 72, title: "叶绿体电子断层扫描", titleEn: "Thylakoid", year: 2019, category: "医学图像", status: "filled", status: "filled", pdfFile: "叶绿体电子断层扫描 Thylakoid.pdf", noteFile: "叶绿体电子断层扫描 Thylakoid.md" },
        { id: 73, title: "医学报告生成IIHT", titleEn: "Medical Report IIHT", year: 2023, category: "医学图像", status: "filled", status: "filled", pdfFile: "医学报告生成IIHT Medical Report IIHT.pdf", noteFile: "IIHT_Medical_Report_Generation_超精读笔记_已填充.md" },
        { id: 74, title: "医学图像分类", titleEn: "Medical Classification", year: 2023, category: "医学图像", status: "filled", status: "filled", pdfFile: "医学图像分类 Medical Classification.pdf", noteFile: "医学图像分类 Medical Classification.md" },
        { id: 75, title: "医学图像小样本学习", titleEn: "Medical Few-Shot", year: 2023, category: "医学图像", status: "filled", status: "filled", pdfFile: "医学图像小样本学习 Medical Few-Shot.pdf", noteFile: "Few-shot_Medical_Imaging_Inference_超精读笔记_已填充.md" },
        ...
        { id: 79, title: "直肠分割放疗", titleEn: "Deep Rectum", year: 2023, category: "医学图像", status: "filled", status: "filled", pdfFile: "直肠分割放疗 Deep Rectum.pdf", noteFile: "Deep_Learning_Rectum_Segmentation_Radiotherapy_超精读笔记.md" },
